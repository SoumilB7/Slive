...
- Pick **Custom…** in the picker to type an inline prompt instead of using a
  file.
- Edit a file and the change takes effect on the next assistant request — no
  rebuild needed.

The examples below ship as starting points; add your own freely.
